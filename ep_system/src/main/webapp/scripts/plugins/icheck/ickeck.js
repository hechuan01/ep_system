...
function showall(thischeckbox) {
    if ($(thischeckbox).find("ins").hasClass("checked")) {

        $("#citys ins[name='field']").removeClass("checked");
    }
    else {
        $("#citys ins[name='field']").addClass("checked");
    }

}
function showothers() {
    var checked = $("#citys ins[name='field'][class='checked']");
    var needchecked = $("#citys ins[name='field'][class!='checked']")
    checked.removeClass("checked");
    needchecked.addClass("checked");
}
