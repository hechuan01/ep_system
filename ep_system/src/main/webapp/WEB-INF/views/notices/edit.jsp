...
<body>
<div class="MyPosition"><span class="gray">我的位置：</span> 公告 / 公告管理 / 修改公告</div>
    ...
    <form role="form" id="form"  name="form"  enctype="multipart/form-data" class="col-sm-12 col-md-12 col-lg-12"
        ...
        <div class="row margin-top-25">
            ...
            <div class="text-center col-sm-6 col-md-6 col-lg-6">
                ...
                <button type="button" class=" btn btn-sm btn-primary" onclick="window.parent.ContentTabs.removePage('修改公告','公告管理')"
...
<script type="text/javascript">
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.state) {
                        ...
                        window.parent.ContentTabs.removePage('修改公告','公告管理')
                    } else {
    ...
    $(function () {
        ...
        $.ajax({///获取公告信息
            type: "POST",
            url: "${ctx}/notices/${noticeid}/getById.html",
            //返回数据的格式
            dataType: "json",
            success: function (data) {
                ///初始化富文本编辑器内容
                editor.$txt.html(data.content);
                sysNotices.id(data.id);
                sysNotices.title(data.title);

                sysNotices.endtime(new Date(data.endtime));
                ///初始化文件选择内容
                ...
                $("#time").datetimepicker({
                    ...
                    .on('changeDate', function (ev) {
                        ...
                        /*console.log(ev.date)
                         var data = moment(ev.date);
                         $("#endtime").val(data);
                         sysNotices.starttime($("#endtime").val());*/
        ...
        $.ajax({///
            type: "POST",
            url: "${ctx}/notices/${noticeid}/getNoticeRole.html",
            //返回数据的格式
